...
:::{#def-h1}
## Hausdorff Distance 
Let $(Z,d)$ be a metric space and $X, Y\subset$ compact subsets.
$$
...
![$S^1$ is the circle with circumference $2\pi$](circle.png){width="300"}
...
$$
d_{GH}(X,M)\geq\min\bigg\{\color{green}{\frac{1}{2}}d_H(X, S^1),\color{green}{\frac{2\rho}{3}}\bigg\}.
$$
